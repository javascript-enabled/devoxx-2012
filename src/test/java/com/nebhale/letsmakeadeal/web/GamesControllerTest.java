...
public final class GamesControllerTest {
    ...
    private final MockMvc mockMvc = standaloneSetup(new GamesController(gameRepository, new GameResourceAssembler(), new DoorsResourceAssembler(new DoorResourceAssembler()))) //
    .build();
